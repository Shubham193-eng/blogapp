...
public class CustomUserDetailsService implements UserDetailsService {
    ...
    public UserDetails loadUserByUsername(String usernameOrEmail) throws UsernameNotFoundException {
        ...
        //if record find it will return the entity obj.
        User user = userRepository.findByUsernameOrEmail(usernameOrEmail, usernameOrEmail).orElseThrow(() ->
                new UsernameNotFoundException("User not found with username or email" + usernameOrEmail)
        );
        //User class is built in class which take argument grantedauthority  so we have to map set<roles> to set of granted authority
        //this class return to the userDetails obj
